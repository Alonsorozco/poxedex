        ...
        fetch(endpoint)
            ...
            .then(function (data) {
                ...
                data.results.forEach(function(pokemon) {
                            ...
                            document.getElementById('pokemonDamage').addEventListener('click', function(e){// acciones que se deben realizar 
                            /*
                            ?! hacer funcion para obterner relaciones de daños 
                            @param pokemonDamage {}hacer funcion para obtener los que tienen misma habilidad 
                            ! insertar relaciones de daños modal
                            ! insertar los pokemones la misma habilidad  
                            */ 
